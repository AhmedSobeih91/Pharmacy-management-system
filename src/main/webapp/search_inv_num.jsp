...
<body>
	...
	try {
		int inv_num = Integer.parseInt(request.getParameter("inv_num"));
		salesdao sales = new salesdao();
		sale = sales.selectWithInv(inv_num);
	} catch (Exception ex) {
		RequestDispatcher req = request.getRequestDispatcher("errorpageinv_num.jsp");
